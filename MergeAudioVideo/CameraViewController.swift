...
//  ConvinceMe-Swift
//
//  Created by Prabhat on 13/06/20.
//  Copyright © 2020 Qasim Abbas. All rights reserved.
//
...
class CameraViewController: UIViewController {
    ...
    @IBOutlet weak var mainCercial: UIImageView!
    @IBOutlet weak var smallCercial: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        startStop = false
        mainCercial.image = #imageLiteral(resourceName: "circel_red")
        smallCercial.image = #imageLiteral(resourceName: "circel_white")
        ...
        if let previewView = self.previewView {
            ...
            self.cView.addSubview(previewView)
        }
...
//        NextLevel.shared.automaticallyUpdatesDeviceOrientation = true
        ...
        // video configuration
        nextLevel.videoConfiguration.maximumCaptureDuration = CMTimeMakeWithSeconds(30, preferredTimescale: 600)
...
//    }
    ...
    @IBAction func startStpBtnAction(_ sender: UIButton) {
        
        if startStop == false {
            startStop = true
            mainCercial.image = #imageLiteral(resourceName: "circel_white")
            smallCercial.image = #imageLiteral(resourceName: "circel_red")
...
extension CameraViewController {
    ...
    internal func saveVideo(withURL url: URL) {
        ...
        let vc = storyboard?.instantiateViewController(identifier: "VideoVC_Id") as! VideoVC
        vc.videoURL = url
